...
基线日期：2026-07-28；Git 功能基线 `2377cd3`。状态针对本表所列能力的完整范围，不把“有代码”或“测试通过”自动提升为真实环境或生产可用。
...
| 主观题评分 | PARTIAL | 线性代数 registry、离线数学验证、Codex/Worker 建议和教师复核已实现；真实 Provider 仍 unavailable，不能宣称真实质量 |
